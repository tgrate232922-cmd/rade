...
class SchemaController extends Controller
{
    ...
    public function schemaSelect($id)
    {
        ...
        return [
            ...
            'number_period' => ($schema->return_type == 'period' ? $schema->number_of_period : 'Unlimited') . ($schema->number_of_period == 1 ? ' Day' : ' Days'),
            'capital_back' => $schema->capital_back ? 'Enabled' : 'No',
