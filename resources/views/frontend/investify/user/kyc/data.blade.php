    ...
    @if($field['type'] == 'file')
        <div class="rock-upload-input">
            ...
            <div class="upload-custom-file without-image">
                <input type="file" name="kyc_credential[{{$field['name']}}]" id="{{ $key }}" @if($field['validation'] == 'required') required @endif accept=".gif, .jpg, .png" onchange="showCloseButton(event)" />
                <label for="{{ $key }}">
                    <span class="upload-icon">
                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                            ...
                            <defs>
                                ...
                                <filter id="filter1_i_2427_12057" x="12.5" y="4.5"
                                    width="19" height="31"
                                    filterUnits="userSpaceOnUse"
                                    color-interpolation-filters="sRGB">
                                    <feFlood flood-opacity="0"
                                ...
                                <linearGradient id="paint0_linear_2427_12057" x1="6"
                                    y1="18" x2="28.1538" y2="51.2308"
                                    gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#FDD819" />
                                    <stop offset="1" stop-color="#F81717" />
                                </linearGradient>
                                <linearGradient id="paint1_linear_2427_12057"
                                    x1="16.5" y1="31.5" x2="39.4245" y2="18.7641"
                                    gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#FDD819" />
                                    <stop offset="1" stop-color="#F81717" />
                                </linearGradient>
    ...
    @else
        <div class="rock-single-input">
            ...
            <div class="input-field">
                <input type="text" name="kyc_credential[{{$field['name']}}]" @if($field['validation'] == 'required') required @endif>
            </div>
        </div>
    @endif
