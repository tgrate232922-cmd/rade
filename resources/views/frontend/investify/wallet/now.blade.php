                                    ...
                                    <div class="rock-single-input">
                                        ...
                                        <div class="input-select">
                                            <select name="from_wallet">
                                                <option value="1">{{ __('Funding Wallet').' ('. $user->balance.' '.$currency .')' }}</option>
                                                <option selected value="2">
                                                    {{ __('Spot Wallet').' ('. $user->profit_balance.' '.$currency .')' }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="rock-single-input">
                                    ...
                                    <div class="rock-single-input">
                                        ...
                                        <div class="input-select">
                                            <select name="to_wallet">
                                                <option selected value="1">{{ __('Funding Wallet').' ('. $user->balance.' '.$currency .')' }}
                                                </option>
                                                <option value="2">{{ __('Spot Wallet').' ('. $user->profit_balance.' '.$currency .')' }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
