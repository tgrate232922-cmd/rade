  ...
  <![endif]-->
    ...
    <a href="{{ route('user.dashboard') }}">
        ...
        <span class="text">{{ __('Dashboard') }}</span>
                ...
                <li @if(Route::is('user.copy-trade.*')) class="active" @endif>
                    <a href="{{ route('user.copy-trade.index') }}">
                        <span class="icon">
                            <svg width="31" height="30" viewBox="0 0 31 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M5.5 23.75C5.5 23.0596 6.05964 22.5 6.75 22.5H24.25C24.9404 22.5 25.5 23.0596 25.5 23.75C25.5 24.4404 24.9404 25 24.25 25H6.75C6.05964 25 5.5 24.4404 5.5 23.75Z" fill="white"/>
                                <path d="M8 18.75C8 17.7145 8.83947 16.875 9.875 16.875C10.9105 16.875 11.75 17.7145 11.75 18.75V23.75H8V18.75Z" fill="white"/>
                                <path d="M13.625 13.75C13.625 12.7145 14.4645 11.875 15.5 11.875C16.5355 11.875 17.375 12.7145 17.375 13.75V23.75H13.625V13.75Z" fill="white"/>
                                <path d="M19.25 8.75C19.25 7.71447 20.0895 6.875 21.125 6.875C22.1605 6.875 23 7.71447 23 8.75V23.75H19.25V8.75Z" fill="white"/>
                                <path opacity="0.4" d="M6.74112 13.4911C7.22927 13.0029 8.02073 13.0029 8.50888 13.4911L10.5 15.4822L16.1161 9.86612C16.6043 9.37796 17.3957 9.37796 17.8839 9.86612L19.25 11.2322L23.3661 7.11612C23.8543 6.62796 24.6457 6.62796 25.1339 7.11612C25.622 7.60427 25.622 8.39573 25.1339 8.88388L20.1339 13.8839C19.6457 14.372 18.8543 14.372 18.3661 13.8839L17 12.5178L11.3839 18.1339C10.8957 18.622 10.1043 18.622 9.61612 18.1339L6.74112 15.2589C6.25296 14.7707 6.25296 13.9793 6.74112 13.4911Z" fill="white"/>
                            </svg>
                        </span>
                        <span class="text">{{ __('Copy Trade') }}</span>
                    </a>
                </li>
