    ...
    <a href="{{ route('user.dashboard') }}">
       <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
        ...
        <span>{{ __('Dashboard') }}</span>
                        ...
                        <li class="{{ isActive('user.copy-trade*') }}">
                            <a href="{{ route('user.copy-trade.index') }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                                        d="M4 19C4 18.4477 4.44772 18 5 18H20C20.5523 18 21 18.4477 21 19C21 19.5523 20.5523 20 20 20H5C4.44772 20 4 19.5523 4 19Z"
                                        fill="white" />
                                    <path
                                        d="M6 15.5C6 14.6716 6.67157 14 7.5 14C8.32843 14 9 14.6716 9 15.5V19H6V15.5Z"
                                        fill="white" />
                                    <path
                                        d="M11 10.5C11 9.67157 11.6716 9 12.5 9C13.3284 9 14 9.67157 14 10.5V19H11V10.5Z"
                                        fill="white" />
                                    <path
                                        d="M16 6.5C16 5.67157 16.6716 5 17.5 5C18.3284 5 19 5.67157 19 6.5V19H16V6.5Z"
                                        fill="white" />
                                    <path opacity="0.4"
                                        d="M5.29289 10.2929C5.68342 9.90237 6.31658 9.90237 6.70711 10.2929L8.5 12.0858L13.2929 7.29289C13.6834 6.90237 14.3166 6.90237 14.7071 7.29289L16 8.58579L19.2929 5.29289C19.6834 4.90237 20.3166 4.90237 20.7071 5.29289C21.0976 5.68342 21.0976 6.31658 20.7071 6.70711L16.7071 10.7071C16.3166 11.0976 15.6834 11.0976 15.2929 10.7071L14 9.41421L9.20711 14.2071C8.81658 14.5976 8.18342 14.5976 7.79289 14.2071L5.29289 11.7071C4.90237 11.3166 4.90237 10.6834 5.29289 10.2929Z"
                                        fill="white" />
                                </svg>
                                <span>{{ __('Copy Trade') }}</span>
                            </a>
                        </li>
