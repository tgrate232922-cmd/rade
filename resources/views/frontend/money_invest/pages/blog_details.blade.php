...
@section('page-content')
    <section class="section-style-2 light-yellow-bg">
        <div class="container">
            <div class="row">
                <div
                    class="col-xxl-4 col-xl-6 col-lg-12 col-md-12 col-sm-12 order-xl-2 order-lg-2 order-md-2 order-sm-2 order-xxl-1 order-1">
                    <div class="site-sidebar">
                        <div class="single-sidebar">
                            <h3>{{ $data['sidebar_widget_title'] }}</h3>
                            <ul>
                                @foreach($blogs as $recent)
                                    <li><a href="{{ route('blog-details',$recent->id) }}">{{ Str::limit($recent->title,35)   }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                ...
                <div
                    class="col-xxl-8 col-xl-12 col-lg-12 col-md-12 col-sm-12 order-xl-1 order-lg-1 order-md-1 order-sm-1 order-xxl-2">
