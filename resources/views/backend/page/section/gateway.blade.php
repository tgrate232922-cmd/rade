                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-card">
                                ...
                                <div class="site-card-body">
                                    <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                        ...
                                        <div class="site-input-groups row">
                                            <label for=""
                                                   class="col-sm-3 col-label">{{ __('Gateway Title Small') }}</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="site-input-groups row">
                                            <label for=""
                                                   class="col-sm-3 col-label">{{ __('Gateway Title Big') }}</label>
                                            <div class="col-sm-9">
                            ...
                            <div class="section-design-nb">
                                <strong>{{ __('NB:') }}</strong>{{ __('Gateway will come from') }} <a
