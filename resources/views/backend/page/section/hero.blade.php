                                            ...
                                            @if($key == 'en')
                                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="site-input-groups">
                                                        ...
                                                        <div class="site-input-groups">
                                                            <div class="site-input-groups">
                                                                <input type="text" name="hero_button1_url"
                                                                       class="box-input"
                                                    ...
                                                    <div class="site-input-groups">
                                                        ...
                                                        <div class="site-input-groups">
                                                            <select name="hero_button1_target" class="form-select">
                                                                <option
                                                                    @if($data->hero_button1_target == '_self') selected
                                                                    @endif value="_self">{{ __('Same Tab') }}</option>
                                                                <option
                                                                    @if($data->hero_button1_target == '_blank') selected
                                            ...
                                            @if($key == 'en')
                                                ...
                                                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="site-input-groups">
                                                        <label for="" class="box-input-label">{{ __('Target') }}</label>
                                                        <div class="site-input-groups">
                                                            <select name="hero_button2_target" class="form-select"
                                                                    id="">
                                                                <option
                                        ...
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="hero_right_img" id="heroRightImg"
                                                       accept=".gif, .jpg, .png"/>
                                                <label for="heroRightImg" id="hero_right_img"
                                                       @if($data->hero_right_img) class="file-ok"
                                                       style="background-image: url({{ asset($data->hero_right_img) }})" @endif>
                                        ...
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="hero_right_top_img" id="heroRightTopImg"
                                                       accept=".gif, .jpg, .png"/>
                                                <label for="heroRightTopImg" id="hero_right_top_img"
                                                       @if($data->hero_right_top_img) class="file-ok"
