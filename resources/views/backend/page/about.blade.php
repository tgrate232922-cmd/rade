                            ...
                            <div class="site-card">
                                ...
                                <div class="site-card-body">
                                    <form action="{{ route('admin.page.update') }}" method="post"
                                        ...
                                        <div class="site-input-groups row">
                                            <label for=""
                                                   class="col-sm-3 col-label">{{ __('About Us Left Image Badge') }}<i
                                        ...
                                        <div class="site-input-groups row">
                                            <label for=""
                                                   class="col-sm-3 col-label">{{ __('About Us Title Big') }}</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="site-input-groups row">
                                            <label for=""
                                                   class="col-sm-3 col-label">{{ __('About Us Side Content') }}</label>
                                            <div class="col-sm-9">
